...
const App = () => {
  ...
  const indiaApiKey = process.env.REACT_APP_INDIA; // Use the specific API key for India Special
    ...
    <div>
      <Router>
        ...
        <Switch>
          ...
          <Route exact path="/india-special">
            <News setProgress={setProgress} apiKey={indiaApiKey} key="india-special" pageSize={pageSize} country="in" category="general" />
          </Route>
        </Switch>
      </Router>
    </div>
