...
const App = () => {
  ...
  const apikey = process.env.REACT_APP_INDIA; // Use the specific API key for India Special
      ...
      <Router>
        ...
        <Switch>
          ...
          <Route exact path="/india-special">
            <News setProgress={setProgress} apiKey={apikey} key="india-special" pageSize={pageSize} country="in" category="india-special" />
          </Route>
        </Switch>
      </Router>
    </div>
